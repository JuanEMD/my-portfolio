...
const moreBtnClasses = "opacity-0 inline-flex items-center gap-[0.4rem] px-[1.1rem] py-[0.45rem] rounded-full border border-btn-border bg-btn-bg text-btn-text text-[0.78rem] font-medium cursor-pointer tracking-[0.02em] transition-[opacity,transform] duration-150 hover:opacity-85 hover:-translate-y-px";
...
const Skills = ({ skills }) => {
    ...
    const targetAnimationElements = [{ element: "stack-skill-card", identificatorType: "class" }, { element: "more-skills", identificatorType: "id", animation: "animate-fade-right" }];
    ...
    return (
        <div className={wrapperClasses}>
            ...
            <div className={moreRowClasses}>
                <button id="more-skills" className={moreBtnClasses} onClick={() => setModalOpen(true)}>
                    <PlusCircle className="w-3.25 h-3.25" />
                    {t("skills.allSkills")}
